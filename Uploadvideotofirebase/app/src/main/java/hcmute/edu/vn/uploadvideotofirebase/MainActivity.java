...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        textView = findViewById(R.id.tv_choosefile);
    ...
    private void UploadVideo(){
        ...
        String search = editText.getText().toString().toLowerCase(Locale.ROOT);
        if(videoUri != null || !TextUtils.isEmpty(videoName)){
            ...
            Toast.makeText(this, "All files are required", Toast.LENGTH_SHORT).show();
        }
    }
}